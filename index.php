...
<!-- End Google Tag Manager (noscript) -->
    ...
    ?>
        ...
        <section class="container module module-two-featured-product">
            <div class="row d-flex justify-content-center module-heading">
                <h4>Novelties</h4>
            </div>
            <div class="row">
                <div class="col product first-child">
                    ...
                    <div class="featured-product-content">
                        ...
                        <a href="gallery.php">Discover the collection</a>
                    </div>
                </div>
                <div class="col product last-child">
                    ...
                    <div class="featured-product-content">
                        ...
                        <a href="gallery.php">Discover more designs</a>
                    </div>
                </div>
            </div>
        </section>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col footer-info-contents">
                        ...
                        <br>
                        <a href="contact.php">info@maavaishnojewellers.org</a>
                    </div>
                    <div class="col footer-info-contents">
                        <h4>Expertise</h4>
